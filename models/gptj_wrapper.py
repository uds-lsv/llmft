...
from transformers.models.gptj import GPTJModel, GPTJForSequenceClassification, GPTJForCausalLM
...
class GPTJWithClassifier(GPTJForSequenceClassification):
    ...
    def forward(
        ...
        if self.config.pad_token_id is None:
            ...
            if input_ids is not None:
                # count non-padding tokens and substract 1 because of indexing
...
class GPTJWithLMClassifier(GPTJForCausalLM):
    def __init__(self, config):
        super().__init__(config)
